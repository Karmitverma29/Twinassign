...
function ProductList() {
  ...
  const columns = [
    { field: "id", headerName: "ID No.", width: 70 },
...

    {
      ...
      width: 100,
      renderCell: (params) => (
        <Link className="view" to={`/products/${params.id}`}>
          View Details
        </Link>
      ),
    },
  ...
  if (loading) {
    return (
      <img
        style={{ height: "150px", width: "150px", marginTop: "12%" }}
      ...
      <div className="product-list-controls">
        <div className="search">
          <input
            ...
            placeholder="Search Products ex:phone"
          />
        </div>
